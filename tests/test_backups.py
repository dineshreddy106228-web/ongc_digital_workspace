            ...
            with patch.object(backups, "create_database_backup", return_value=fake_artifact):
                ...
                try:
                    ...
                    with tarfile.open(artifact.temp_path, "r:gz") as archive:
                        ...
                        assert "task_management" in manifest["database_backup"]["included_modules"]
                        assert "inventory_monitoring" in manifest["database_backup"]["included_modules"]
                        assert "quality_control" in manifest["database_backup"]["included_modules"]
                        assert "corporate_specifications_management" in manifest["database_backup"]["included_modules"]
                finally:
                    artifact.cleanup()
