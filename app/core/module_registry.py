...
MODULES = [
    ...
    {
        "key": "nabl_accreditkit",
        "name": "NABL AccredKit",
        "permission_code": "nabl",
        "blueprint_import": "app.modules.nabl:nabl_bp",
        "url_prefix": "/nabl",
        "endpoint": "nabl.landing",
        "feature_flag": "ENABLE_NABL",
        "nav_visible": True,
        "dashboard_visible": True,
        "roles_allowed": [ADMIN_ROLE, SUPERUSER_ROLE, USER_ROLE],
        "status": "active",
        "description": "Guided NABL ISO/IEC 17025 accreditation preparation with auto-filled SOP and REC drafts",
        "nav_label": "NABL AccredKit",
        "icon": "🧪",
    },
    {
        "key": "committee",
