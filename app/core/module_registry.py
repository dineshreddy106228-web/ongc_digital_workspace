...
MODULES = [
    ...
    },
    {
        ...
        "permission_code": "manpower",
        "blueprint_import": "app.modules.manpower:manpower_bp",
        "url_prefix": "/manpower",
        "endpoint": "manpower.landing",
        "feature_flag": "ENABLE_MANPOWER_PLANNING",
        "nav_visible": False,
        "dashboard_visible": False,
        "roles_allowed": [ADMIN_ROLE, SUPERUSER_ROLE, USER_ROLE],
        "status": "active",
        "description": "Location-wise chemistry manpower view with employee vintage drilldowns",
        "nav_label": "Manpower Planning",
        "icon": "👥",
    },
    {
        "key": "csc_workflow",
    ...
    {
        "key": "quality_control",
        "name": "QC Laboratory Monitoring",
        "permission_code": "quality_control",
        "blueprint_import": "app.modules.quality_control:quality_control_bp",
        "url_prefix": "/quality-control",
        "endpoint": "quality_control.landing",
        "feature_flag": "ENABLE_QUALITY_CONTROL",
        "nav_visible": True,
        "dashboard_visible": True,
        "roles_allowed": [ADMIN_ROLE, SUPERUSER_ROLE, USER_ROLE],
        "status": "active",
