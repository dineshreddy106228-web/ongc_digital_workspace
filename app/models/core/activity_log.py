...
class ActivityLog(db.Model):
    ...
    ACTION_COLORS = {
        ...
        "user_deleted": "var(--danger, #ef4444)",
        ...
        "announcements_deleted": "var(--danger, #ef4444)",
    ...
    def summary(self):
        ...
        verb_map = {
            ...
            "user_deleted": f"deleted {self.entity_type.lower()} {self.entity_name}",
            ...
            "announcements_deleted": f"deleted {self.entity_name}",
